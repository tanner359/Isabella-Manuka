...
namespace Thry.TPS
{
    public class TPSComponentEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            _isPrefabEditing = UnityEditor.SceneManagement.PrefabStageUtility.GetCurrentPrefabStage() != null
            ...
            EditorGUILayout.LabelField($"<color=#ff00ff><size=25> Orifice </size></color>", Style.RichTextCenter, GUILayout.Height(30));
        ...
        void ChannelGUI()
        {
            ...
            if(EditorGUI.EndChangeCheck())
            {
                ...
                _component.Channel = newChannel -1;
                _component.IsAnimatorDirty = true;
            }
            if(_component.Channel == -1)
            {
