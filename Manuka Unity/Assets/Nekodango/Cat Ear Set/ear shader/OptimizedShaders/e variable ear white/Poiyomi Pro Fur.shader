Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Fur/57c3040a18c85fd4586777bdd416a03f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFur(in float2 furSettings, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float ao = lerp(1, smoothstep(float4(0,1,0,1).x, float4(0,1,0,1).y, furHeightMap), (0.2 /*_FurAO*/) * furMask);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2906642,0.166759,0.1005822,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2906642,0.166759,0.1005822,1).a;
