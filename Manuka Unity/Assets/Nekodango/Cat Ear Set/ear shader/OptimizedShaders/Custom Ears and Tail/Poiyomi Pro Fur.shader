Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Fur/1b4d93fb4f128f049ba891fcc2972ae2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void GeometryProgram(triangle VertexOut p[3], inout TriangleStream <VertexOut> tristream, uint InstanceID : SV_GSInstanceID)
			{
				...
				for (int i = 0; i < 3; i ++)
				{
					...
					if ((1.0 /*_FurUseVertexColorNormals*/))
					{
						float3 vectorTS = t.vertexColor.rgb * 2.0 - 1.0;
						normal = vectorTS.x * t.tangent.xyz + vectorTS.y * t.binormal.xyz + vectorTS.z * normal;
					}
					float3 furGravityOffset = (float3(0, -1, 0) * (furSettings.y * (0.005 /*_FurLength*/)) *(0.5 /*_FurGravityStrength*/)) * smoothstep(-0.5, 1, dot(normal, float3(0, -sign((0.5 /*_FurGravityStrength*/)), 0)) * 0.5 + 0.5);
					t.furSettings = furSettings;
					float3 offset = furGravityOffset + furSettings.y * (0.005 /*_FurLength*/) * normal;
			...
			void applyFur(in float2 furSettings, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float furHeightMap = POI2D_SAMPLER_PAN(_FurHeightMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_FurHeightMapUV*/)], float4(20,20,0,0)), float4(0,0,0,0)).x;
				furHeightMap = saturate(remap(furHeightMap, 0, float4(0,1,0,1).y, float4(0,1,0,1).x, 1));
				float ao = lerp(1, smoothstep(float4(0,1,0,1).x, float4(0,1,0,1).y, furHeightMap), (0.3 /*_FurAO*/) * furMask);
				...
				furTexture.rgb *= poiThemeColor(poiMods, _FurColor.rgb, (0.0 /*_FurColorThemeIndex*/));
				if ((0.0 /*_FurHueShiftEnabled*/))
				{
					furTexture.rgb = hueShift(furTexture.rgb, (0.0 /*_FurHueShift*/) + _Time.x * (0.0 /*_FurHueShiftSpeed*/));
				}
				furTexture.rgb *= ao;
				poiFragData.baseColor = lerp(poiFragData.baseColor, furTexture.rgb, furMask * (1.0 /*_FurTextureApplyToSkin*/));
				if (furSettings.x)
				{
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.354 /*_ShadowBorder*/), (0.252 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.15 /*_Shadow2ndBorder*/), (0.1 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.25 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.354 /*_ShadowBorder*/), (0.252 /*_ShadowBlur*/) * blurMap.r, (0.08 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.354 /*_ShadowBorder*/), (0.252 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.15 /*_Shadow2ndBorder*/), (0.1 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.25 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.354 /*_ShadowBorder*/), (0.252 /*_ShadowBlur*/) * blurMap.r, (0.08 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
				float3 indirectColor = 1;
				if (float4(0.8403685,0.741563,0.8960326,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.8403685,0.741563,0.8960326,1).rgb;
				}
				if (float4(0.5121724,0.3857346,0.6070304,1).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.5121724,0.3857346,0.6070304,1).rgb;
					lns.y = float4(0.5121724,0.3857346,0.6070304,1).a - lns.y * float4(0.5121724,0.3857346,0.6070304,1).a;
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(1,0.01002282,0,1).rgb);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? min((2.6 /*_LightingAdditiveLimit*/), unity_LightColor[index].rgb) : unity_LightColor[index].rgb;
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? min((2.6 /*_LightingAdditiveLimit*/), _LightColor0.rgb) : _LightColor0.rgb;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.85 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.808 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.2603273,0.2603273,0.2603273,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.243 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (1.0 /*_RimBaseColorMix*/), (1.81 /*_RimBrightness*/), (1.0 /*_RimBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, (0.0 /*_RimClamp*/), rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				...
				clip(poiFragData.alpha - (0.55 /*_Cutoff*/));
