Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/aa2329a945aa279429ceb291ddf0c61a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float shadowStrength = (0.25 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((2.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.45 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.45 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.45 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				if (IsInMirror())
				...
				#endif
				matcap.rgb *= (3.38 /*_MatcapIntensity*/);
				#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
				matcapMask = POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				matcapMask = 1;
				#endif
				...
				blendMatcap(poiLight, poiFragData, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.139 /*_MatcapMultiply*/), (0.1 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.225 /*_MatcapLightMask*/)
				#ifdef POI_BLACKLIGHT
			...
			{
				float smoothness = (0.783 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.0 /*_MochieMetallicMultiplier*/);
				float specularMask = 1;
				float reflectionMask = 1;
				#if defined(PROP_MOCHIEMETALLICMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 PRBMaps = POI2D_SAMPLER_PAN(_MochieMetallicMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MochieMetallicMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy);
				
				if ((0.0 /*_PBRSplitMaskSample*/))
				{
					PRBMaps.zw = POI2D_SAMPLER_PAN(_MochieMetallicMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MochieMetallicMasksUV*/)], float4(1,1,0,0)), float4(0,0,0,0).xy).zw;
				}
				metallic *= PRBMaps.r;
				...
				#endif
				reflectionMask *= (0.503 /*_MochieReflectionStrength*/);
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[1], percepRough, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(poiMesh.normals[1], percepRough2, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					}
				}
				...
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (0.0 /*_MochieForceFallback*/), (0.0 /*_MochieLitFallback*/), _MochieReflCube, poiCam.reflectionDir);
				reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, poiLight.nDotV), (0.432 /*_RefSpecFresnel*/));
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.0 /*_RimEnviroSharpness*/), (0.2 /*_RimEnviroWidth*/)), (0.2 /*_RimEnviroWidth*/), poiCam.vDotN));
				(0.72 /*_RimEnviroBlur*/) *= 1.7 - 0.7 * (0.72 /*_RimEnviroBlur*/);
				float3 enviroRimColor = 0;
				float interpolator = unity_SpecCube0_BoxMin.w;
				
				if (interpolator < 0.99999)
				{
					float4 reflectionData0 = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.72 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
					float3 reflectionColor0 = DecodeHDR(reflectionData0, unity_SpecCube0_HDR);
					float4 reflectionData1 = UNITY_SAMPLE_TEXCUBE_SAMPLER_LOD(unity_SpecCube1, unity_SpecCube0, poiMesh.normals[1], (0.72 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
				...
				{
					float4 reflectionData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.72 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
					enviroRimColor = DecodeHDR(reflectionData, unity_SpecCube0_HDR);
				}
				half enviroMask = 1;
				#if defined(PROP_RIMENVIROMASK) || !defined(OPTIMIZER_ENABLED)
				enviroMask = poiMax(POI2D_SAMPLER_PAN(_RimEnviroMask, _MainTex, poiMesh.uv[(0.0 /*_RimEnviroMaskUV*/)], float4(0,0,0,0)).rgb);
				#endif
				float3 envRimCol = lerp(0, max(0, (enviroRimColor - (0.025 /*_RimEnviroMinBrightness*/)) * poiFragData.baseColor), enviroRimAlpha).rgb * enviroMask * (0.25 /*_RimEnviroIntensity*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float4 col = POI2D_SAMPLER_PAN(_OutlineTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_OutlineTextureUV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, _LineColor.rgb, (0.0 /*_LineColorThemeIndex*/)), _LineColor.a);
