...
Shader "Leviant's Shaders/UberShader v2.9"
{
	Properties 
	{
		...
		[PowerSlider(2.0)]_SIntensity_X ("Screen Shake/Intensity X", Range(-1, 1)) = 0.01
		[PowerSlider(2.0)]_SIntensity_Y ("Screen Shake/Intensity Y", Range(-1, 1)) = 0.01
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+2001" "RenderType"="Transparent" "IgnoreProjector" = "True" "ForceNoShadowCasting" = "True" "PreviewType" = "None"}
		ZWrite Off
		ZTest Off
		Cull Off
