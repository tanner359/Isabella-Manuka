...
float4 frag(v2f i, uint facing: SV_IsFrontFace): COLOR
{
	...
	if ((1.0 /*_commentIfZero_EnableOutlinePass*/))
	{
	...
	clip(OutlineMask * (0.15 /*_LineWidth*/) - 0.001);
	col = col * 0.00000000001 + tex2D(_OutlineTexture, TRANSFORM_TEX(poiMesh.uv[(0.0 /*_OutlineTextureUV*/)], _OutlineTexture) + _Time.x * float4(1,0,0,0));
	col.a *= albedo.a;
	...
	#endif
	finalColor.rgb += (col.rgb * (5.0 /*_OutlineEmission*/));
}
else
{
	clip(-1);
