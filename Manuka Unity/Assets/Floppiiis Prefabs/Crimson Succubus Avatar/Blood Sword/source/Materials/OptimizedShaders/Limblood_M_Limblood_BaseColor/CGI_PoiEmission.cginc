...
{
    float3 emission0 = 0;
    float emissionStrength0 = (901.0 /*_EmissionStrength*/);
    ...
    float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (1.0 /*_GITDEMinEmissionMultiplier*/), (0.0 /*_GITDEMaxEmissionMultiplier*/), (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/));
        ...
        {
            emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(15,0,0,0)).rgb * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(1,0.004716992,0.004716992,1).rgb;
        }
        else
        {
            emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(1,0.004716992,0.004716992,1).rgb;
        }
    #else
        emissionColor0 = lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(1,0.004716992,0.004716992,1).rgb;
    #endif
    ...
    {
        emissionStrength0 *= calculateBlinkingEmission((0.2 /*_EmissiveBlink_Min*/), (1.0 /*_EmissiveBlink_Max*/), (4.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
    }
    ...
    float3 emissionColor1 = 0;
    #ifdef EFFECT_HUE_VARIATION
        emissionStrength1 = (14.0 /*_EmissionStrength1*/);
        #ifdef POI_AUDIOLINK
            
            if (poiMods.audioLinkTextureExists)
            {
                
                if ((0.0 /*_EnableEmission1StrengthAudioLink*/))
                {
                    emissionStrength1 *= poiMods.audioLink[(0.0 /*_AudioLinkEmission1StrengthBand*/)];
                }
                
                if ((0.0 /*_EnableEmission1CenterOutAudioLink*/))
                {
                    emissionStrength1 *= getBandAtTime((0.0 /*_AudioLinkEmission1CenterOutBand*/), saturate(1 - poiLight.nDotV), (1.0 /*_Emission1CenterOutAudioLinkWidth*/));
                }
                emissionStrength1 += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, getBandAtTime((0.0 /*_AudioLinkEmission1CenterOutAddBand*/), saturate(1 - poiLight.nDotV), (1.0 /*_Emission1CenterOutAddAudioLinkwidth*/)));
                emissionStrength1 += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkAddEmission1Band*/)]);
                emissionStrength1 = max(emissionStrength1, 0);
            }
        #endif
        float glowInTheDarkMultiplier1 = calculateGlowInTheDark((0.0 /*_GITDEMinLight1*/), (1.0 /*_GITDEMaxLight1*/), (1.0 /*_GITDEMinEmissionMultiplier1*/), (0.0 /*_GITDEMaxEmissionMultiplier1*/), (0.0 /*_EnableGITDEmission1*/), (0.0 /*_GITDEWorldOrMesh1*/));
        #if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
            
            if (!(0.0 /*_EmissionCenterOutEnabled1*/))
            {
                emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(0,0,0,0)) * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * float4(1,0,0,1).rgb;
            }
            else
            {
                emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * float4(1,0,0,1).rgb;
            }
        #else
            emissionColor1 = lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * float4(1,0,0,1).rgb;;
        #endif
        ...
        if ((0.0 /*_ScrollingEmission1*/))
        {
            ...
            {
                #if defined(PROP_EMISSIONSCROLLINGCURVE1) || !defined(OPTIMIZER_ENABLED)
                    emissionStrength1 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve1, _MainTex, TRANSFORM_TEX(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], _EmissionScrollingCurve1) + (dot(pos1, float4(0,-10,0,0)) * (20.0 /*_EmissiveScroll_Interval1*/)) + _Time.x * (10.0 /*_EmissiveScroll_Velocity1*/));
                #endif
            }
            else
            {
        ...
        #if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
            float emissionMask1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask1, _MainTex, TRANSFORM_TEX(poiMesh.uv[(0.0 /*_EmissionMask1UV*/)], _EmissionMask1) + _Time.x * float4(0,0,0,0));
        #else
        ...
        #ifdef POI_DISSOLVE
            if ((2.0 /*_DissolveEmission1Side*/) != 2)
            {
                emission1 *= lerp(1 - dissolveAlpha, dissolveAlpha, (2.0 /*_DissolveEmission1Side*/));
            }
        #endif
    #endif
