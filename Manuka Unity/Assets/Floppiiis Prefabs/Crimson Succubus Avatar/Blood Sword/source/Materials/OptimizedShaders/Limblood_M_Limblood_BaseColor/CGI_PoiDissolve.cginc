...
float _DissolveEdgeEmission_Limblood_M_Limblood_BaseColor;
...
float _DissolveAlpha_Limblood_M_Limblood_BaseColor;
...
void calculateDissolve(inout float4 albedo, inout float3 dissolveEmission)
{
    ...
    #if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
        dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiMesh.uv[(0.0 /*_DissolveToTextureUV*/)], float4(0,0,0,0)) * float4(1,1,1,1);
    #else
    ...
    #endif
    float da = _DissolveAlpha_Limblood_M_Limblood_BaseColor
    + (0.0 /*_DissolveAlpha0*/)
    + (0.0 /*_DissolveAlpha1*/)
    + (0.0 /*_DissolveAlpha2*/)
    + (0.0 /*_DissolveAlpha3*/)
    ...
    {
        da = remap(da, 0, 1, -(0.222 /*_DissolveEdgeWidth*/), 1);
        dissolveAlpha = da;
        ...
        edgeAlpha = remapClamped(noise, da + (0.222 /*_DissolveEdgeWidth*/), da, 0, 1) * (1 - dissolveAlpha);
    }
    else if ((1.0 /*_DissolveType*/) == 2) // Point to Point
    {
        ...
        if ((0.0 /*_DissolveP2PWorldLocal*/) != 1)
        {
            ...
            edgeAlpha = smoothstep((0.2 /*_DissolveP2PEdgeLength*/) + .00001, 0, distanceTo);
    ...
    if ((0.222 /*_DissolveEdgeWidth*/))
    {
        edgeColor = tex2D(_DissolveEdgeGradient, TRANSFORM_TEX(float2(edgeAlpha, edgeAlpha), _DissolveEdgeGradient)) * float4(1,0.006068091,0.006068091,1);
        #ifndef POI_SHADOW
    ...
    dissolveEmission = lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * _DissolveEdgeEmission_Limblood_M_Limblood_BaseColor, smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
}
#endif
