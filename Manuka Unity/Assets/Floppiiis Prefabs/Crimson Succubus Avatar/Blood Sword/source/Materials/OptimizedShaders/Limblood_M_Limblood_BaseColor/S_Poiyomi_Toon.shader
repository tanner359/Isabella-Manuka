Shader "Hidden/Locked/.poiyomi/Poiyomi 7.3/• Poiyomi Toon •/b7a1180bcaecab242a97820add008998"
{
    Properties
    {
        ...
        _MatcapEmissionStrength_Limblood_M_Limblood_BaseColor ("Emission Strength", Range(0, 20)) = 0
        _MatcapIntensity_Limblood_M_Limblood_BaseColor ("Intensity", Range(0, 5)) = 1
        ...
        _DissolveEdgeEmission_Limblood_M_Limblood_BaseColor ("Edge Emission", Range(0, 20)) = 0
        ...
        _DissolveAlpha_Limblood_M_Limblood_BaseColor ("Dissolve Alpha", Range(0, 1)) = 0
