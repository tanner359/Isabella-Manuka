Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/20fbf5df215d0e1449390c95c86f97fa"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					if ((0.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = (_Time.y / (1 / (0.0 /*_FlipbookFPS*/))) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				if ((0.0 /*_FlipbookCrossfadeEnabled*/))
				{
					...
					flipBookPixel = lerp(flipBookPixel, flipbookNextPixel, smoothstep(float4(0.1187533,0.3687532,0,1).x, float4(0.1187533,0.3687532,0,1).y, frac(currentFrame)));
				}
				...
				float flipbookEmissionStrength = (1.14 /*_FlipbookEmissionStrength*/);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
