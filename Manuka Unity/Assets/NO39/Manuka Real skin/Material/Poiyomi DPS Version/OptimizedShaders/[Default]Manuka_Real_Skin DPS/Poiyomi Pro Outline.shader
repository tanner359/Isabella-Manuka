Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Outline/b99a02fd5fb2f7b4eb01ce4f205283ef"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((0.0 /*_LightingMulitlayerNonLinear*/))
				{
					...
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.158 /*_Shadow3rdBorder*/), (0.398 /*_Shadow3rdBlur*/) * blurMap.b);
				...
				else
				{
					...
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.158 /*_Shadow3rdBorder*/), (0.398 /*_Shadow3rdBlur*/) * blurMap.b);
				...
				if (float4(0.2054128,0.04450252,0.03351663,0.3058824).a > 0)
				{
					#if defined(PROP_SHADOW3RDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(0.2054128,0.04450252,0.03351663,0.3058824).rgb;
					lns.z = float4(0.2054128,0.04450252,0.03351663,0.3058824).a - lns.z * float4(0.2054128,0.04450252,0.03351663,0.3058824).a;
