Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro Outline/36000e7d8851f7746b4b92a14dfe9f7d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if (float4(1,1,1,1).a > 0)
				{
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(1,1,1,1).rgb;
					lns.z = float4(1,1,1,1).a - lns.z * float4(1,1,1,1).a;
