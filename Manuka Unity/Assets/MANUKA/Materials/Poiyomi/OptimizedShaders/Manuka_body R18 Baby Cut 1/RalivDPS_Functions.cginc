...
void PenetratorReshape(inout float4 vertex, inout float3 normal) {
	...
	void OrificeReshape(inout float4 vertex, inout float3 normal, float3 tangent, int vertexId) {
		...
		vertex.xyz += getBlendOffset(2, (0.267 /*_Shape1Depth*/), (0.01 /*_Shape1Duration*/), vertexId, penetrationDepth, normal, tangent, binormal);
		vertex.xyz += getBlendOffset(4, (0.28 /*_Shape2Depth*/), (0.02 /*_Shape2Duration*/), vertexId, penetrationDepth, normal, tangent, binormal);
		...
		normal += getBlendOffset(3, (0.267 /*_Shape1Depth*/), (0.01 /*_Shape1Duration*/), vertexId, penetrationDepth, normal, tangent, binormal);
		normal += getBlendOffset(5, (0.28 /*_Shape2Depth*/), (0.02 /*_Shape2Duration*/), vertexId, penetrationDepth, normal, tangent, binormal);
