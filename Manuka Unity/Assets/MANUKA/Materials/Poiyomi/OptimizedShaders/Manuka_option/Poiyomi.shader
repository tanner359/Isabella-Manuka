Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/b297b727d4a1d6648a4fecf697047838"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.49995 /*_ShadowBorder*/), (0.00009998679 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.49995 /*_ShadowBorder*/), (0.00009998679 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.49995 /*_ShadowBorder*/), (0.00009998679 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.49995 /*_ShadowBorder*/), (0.00009998679 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
				...
				if (float4(1,1,1,1).a > 0)
				{
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(1,1,1,1).rgb;
					lns.y = float4(1,1,1,1).a - lns.y * float4(1,1,1,1).a;
